...
export const SignalMiniIcon: React.FC<IconProps> = ({
  className,
  ...props
}) => {
  return (
    <svg
      ...
      aria-label="Signal Icon" // Add an aria-label for accessibility
...
export const ArrowsUpDownIcon: React.FC<IconProps> = ({
  ...
  return (
    <svg
      ...
      fill="currentColor"
      className={className} // Allow passing className for styling
      aria-label="ArrowsUpDownIcon" // Add an aria-label for accessibility
      {...props} // Spread any additional props
    >
      <path
        fillRule="evenodd"
...
export const CommnadLineIcon: React.FC<IconProps> = ({
  className,
  ...props
}) => {
  return (
    <svg
      ...
      stroke="currentColor"
      className={className} // Allow passing className for styling
      aria-label="CommnadLineIcon" // Add an aria-label for accessibility
      {...props} // Spread any additional props
    >
      <path
        strokeLinecap="round"
...
export const VideoIcon: React.FC<IconProps> = ({ className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      ...
      stroke="currentColor"
      className={className} // Allow passing className for styling
      aria-label="VideoIcon" // Add an aria-label for accessibility
      {...props} // Spread any additional props
    >
      <path
        strokeLinecap="round"
